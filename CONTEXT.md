...
Непрозрачный base64-токен, кодирующий позицию `(created_at, id)` последнего элемента страницы — используется вместо номера страницы во всех list-запросах (см. ADR 0006).
