...
from api.http.dependencies import AdjustInventoryStockDI
from api.http.schemas import InventoryAdjustmentRequest
...
async def adjust_inventory_stock(
    ...
    command: AdjustInventoryStockCommand = request.to_command(
