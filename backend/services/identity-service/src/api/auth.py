...
from api.schemas import TokenResponse, UserCreate, UserResponse, user_response
...
async def register_user(request: UserCreate, handler: RegisterUserDI) -> UserResponse:
