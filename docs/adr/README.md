...
| [0016](0016-ordering-saga-and-bounded-contexts.md) | Ordering: отдельные контексты и оркестрируемая Saga checkout |
...
| ADR | Название |
|---|---|
| [0015](0015-observability-and-asynchronous-trace-propagation.md) | Наблюдаемость: локальный стек и асинхронная W3C-трассировка |
| [0017](0017-dependency-injector-composition-roots.md) | Dependency Injector: composition roots и request-scoped DB sessions |
